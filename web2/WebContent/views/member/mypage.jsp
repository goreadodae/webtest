...
Name : <input type="text" placeholder="이름을 입력하세요" readonly name="userName" value="<%=m.getUserName()%>"/><br><br>
Age : <input type="text" placeholder="나이을 입력하세요" readonly name="age" value="<%=m.getAge()%>"/><br><br>
